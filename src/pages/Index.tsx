      ...
      <main className="flex-1">
        ...
        <section className="bg-primary py-24 md:py-32">
          <div className="container mx-auto px-4 text-center">
            <h1 className="font-heading text-4xl font-extrabold text-primary-foreground md:text-5xl lg:text-6xl leading-tight">
              SNAA Careers<br />Latest Job Openings
            </h1>

            <p className="mt-4 text-lg text-primary-foreground/80 max-w-2xl mx-auto">
              Explore the latest job openings at SNAA Careers. Apply for freshers and experienced roles in Mangalore and across India.
            </p>
        ...
        <section className="container mx-auto px-4 py-12 text-center">
          <h2 className="font-heading text-2xl font-bold mb-4">
            Current Job Openings in Mangalore
          </h2>

          <p className="text-muted-foreground max-w-2xl mx-auto">
            We are hiring for multiple roles including HR Executive, Production Engineer,
            and Maintenance Technician. Freshers and experienced candidates can apply.
          </p>
        </section>
